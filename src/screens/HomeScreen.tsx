        ...
        <>
          ...
          {tab === 'tokens' && (
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filterRow} contentContainerStyle={styles.filterRowContent}>
              ...
              {/* Not a TokenFilter — News isn't a slice of the token
                  list, it's a completely different kind of content
                  (articles, not tokens), so it opens its own dedicated
                  screen (NewsScreen) rather than swapping this list's
                  data the way the other pills do. */}
              {onOpenNews && (
                <TouchableOpacity style={styles.filterPill} onPress={onOpenNews} activeOpacity={0.7}>
                  <NewspaperIcon color={colors.textSecondary} size={13} />
